...
# number of centimeters in a light ns.
...
cen_z = 0.
antpos = []
for row in n.arange(sqSidelength):
    for column in n.arange(sqSidelength):
        antpos.append((dL * row, dL * column, cen_z))

#Set other array parameters here
prms = {
    'name': os.path.basename(__file__)[:-3], #remove .py from filename
    'loc': ('89:00:00.00',  '-79:51:02.1'), 
    'antpos': antpos,
